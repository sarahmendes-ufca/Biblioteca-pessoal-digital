...
'''A classe Relatório se conecta ao banco de dados gera 3 relatórios em formato em gráfico, 
salvando-os como imagem png na pasta graphics '''
class Relatorio:
    def __init__(self):
        pass
...
def gerar_relatorios():
    r = Relatorio()
    r.gerar_grafico_obras()
    r.gerar_grafico_status()
    r.gerar_grafico_media_avaliacoes()